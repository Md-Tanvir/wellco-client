...
const BlogArea = () => {
    ...
    return (
        ...
        <div className="container py-5">
            <h5 className='text-center' data-aos="fade-up">NEWS UPDATE</h5>
          <h2 data-aos="fade-up" className='text-center main-title mb-5'>Latest News and Events</h2>
            ...
            {blogs?.slice(0,3).map((blog) => (
              <div key={blog?.id} className="col">
                <div className="card h-100  blog-card" data-aos="fade-up">
                  <img src={blog?.img} className="card-img-top course-img" alt="" />
